...
- [ ] ключ интеграции 1С, если используется, имеет не менее 32 случайных символов;
...
- [ ] проверено, что 1С не может архивировать товар с ненулевым остатком;
- [ ] проверено, что корректировка не проходит по архивному товару/месту хранения;
- [ ] выгрузка продажи;
- [ ] выгрузка возврата;
