...
from unf_bridge.fresh_probe import SNAPSHOT_SCHEMA_VERSION, metadata_snapshot, write_metadata_snapshot
...
def test_write_metadata_snapshot_creates_parent_and_valid_json(tmp_path):
    ...
    assert payload["entity_set_count"] == 2
